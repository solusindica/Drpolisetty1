...
export default function Awards() {
  const awards = [
    ...
    },
    {
      ...
      organization:
        "Europe-India Centre for Business Industry, Brussels",
      icon: Trophy,
    },
    {
      year: "2024",
    ...
    },
    {
      year: "2024",
      title:
        "Pradhana Mantri Atma Nirbhar Bharat Abhiyan Sangatan Award",
    ...
    },
    {
      year: "2023",
      title:
        "Outstanding Achievement Award for Healthcare Excellence",
    ...
    },
    {
      year: "2023",
      title:
        "Healthcare Leadership Achievers Award – Excellence in Ayurveda",
    ...
    },
    {
      year: "2023",
      title:
        "Global Indian of the Year & World’s Greatest Brands Award",
    ...
    },
    {
      year: "2023",
      title:
        "Special Award – India Start-Up Festival",
    ...
    },
    {
      ...
      organization:
        "Swasthya Global Ayush & Wellness Expo",
      icon: Star,
    },
    ...
    // ================= 2022 =================
    {
      ...
      organization:
        "All-Party Parliamentary Group on Indian Traditional Sciences, UK",
      icon: Trophy,
    },
    {
      year: "2022",
    ...
    },
    {
      ...
      organization:
        "National Ayurvedic Day, Hyderabad",
      icon: Star,
    },
    {
      year: "2022",
      title:
        "Best Integrated Medical Hospital Award",
      organization:
        "On behalf of Sai Ganga Panakeia, Telangana",
      icon: Trophy,
    },
    {
      year: "2022",
    ...
    },
    {
      year: "2022",
      title:
        "Ayurveda Integrated Medicine Expert & Arogya Ratna",
      organization:
        "Public Health Care Council, India",
      icon: Award,
    },
    {
      year: "2022",
    ...
    },
    {
      year: "2022",
      title:
        "Felicitation by Sanskrit Academy of Osmani University",
      organization:
        "For contributions to Ayurveda through Sanskrit",
      icon: Trophy,
    },
    ...
    // ================= 2021 =================
    {
      ...
      organization:
        "National Doctor’s Day, Megacity Navakala Vedika",
      icon: Star,
    },
    ...
    // ================= 2019 =================
    {
      year: "2019",
      title:
        "9th Medgate India Award – Most Innovative Product",
      organization: "India",
      icon: Trophy,
    },
    ...
    // ================= 2013 =================
    {
      ...
      organization:
        "Presented by Dr. APJ Abdul Kalam",
      icon: Star,
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-amber-500 rounded-full blur-[128px] animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-yellow-500 rounded-full blur-[128px] animate-pulse" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-amber-500 to-yellow-600 mx-auto mb-4" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {awards.map((award, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-gradient-to-br from-gray-900 to-black border border-amber-500/30 rounded-2xl group transition-all duration-300 hover:border-amber-500/60 hover:shadow-2xl hover:shadow-amber-500/20"
              >
                {/* Yellow Line on Top */}
                <div className="h-1 w-full bg-gradient-to-r from-amber-400 to-yellow-500 rounded-t-2xl" />
        ...
        <div className="mt-16 bg-gradient-to-br from-gray-900 to-black border border-amber-500/30 rounded-3xl p-10 text-center">
          ...
          <p className="text-gray-300 text-lg leading-relaxed max-w-3xl mx-auto">
            Dr. Polisetty's groundbreaking work has been acknowledged by presidents,
            prime ministers, and global health organizations, cementing his position
            as one of the most influential voices in modern healthcare innovation.
          </p>
        </div>
      </div>
    </section>
